...
document.addEventListener('DOMContentLoaded', function (e) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            readOnlyRatings.className = 'read-only-ratings raty mb-1';
            ...
            if (readOnlyRatings) {
              ...
              <div>
                ...
                <p class="h6 mb-1 text-truncate text-capitalize">${firstCap}</p>
          ...
          render: function (data, type, full, meta) {
            return `
              <div class="text-xxl-center">
                <div class="dropdown">
                  <a href="javascript:void(0);" class="btn btn-icon btn-text-secondary rounded-pill waves-effect dropdown-toggle hide-arrow p-0" data-bs-toggle="dropdown">
          ...
          features: [
            ...
            reviewFilter,
            {
              buttons: [
                {
                  extend: 'collection',
                  className: 'btn btn-primary dropdown-toggle waves-effect',
  ...
  setTimeout(() => {
    const elementsToModify = [
      ...
      { selector: '.dt-search', classToAdd: 'mb-md-5 mb-0' },
      { selector: '.dt-length .form-select', classToAdd: 'me-md-4 me-0' },
      { selector: '.dt-layout-table', classToRemove: 'row mt-2' },
      { selector: '.dt-layout-start', classToAdd: 'px-3' },
      {
        selector: '.dt-layout-end',
        classToAdd: 'px-3 justify-content-md-between justify-content-center d-flex',
        classToRemove: 'justify-content-between d-md-flex'
      },
      { selector: '.review_filter', classToAdd: 'me-md-4' },
      { selector: '.review_filter .form-select', classToAdd: 'w-px-100 form-select-sm' },
      { selector: '.dt-buttons', classToAdd: 'mb-0 w-auto' },
      { selector: '.dt-layout-end', classToAdd: 'd-flex gap-md-0 gap-4' },
