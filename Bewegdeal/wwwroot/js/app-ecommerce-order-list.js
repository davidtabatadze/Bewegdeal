      ...
      columnDefs: [
            ...
            if (paymentStatus) {
              return `
                <h6 class="mb-0 align-items-center d-flex w-px-100 ${paymentStatus.class}">
                  <i class="icon-base ri ri-circle-fill icon-10px me-1"></i>${paymentStatus.title}
                </h6>`;
            }
            return data;
          }
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if (statusInfo) {
              return `
                <span class="badge rounded-pill px-2 ${statusInfo.class} text-capitalized">
                  ${statusInfo.title}
                </span>`;
            }
            return data;
          ...
          render: function (data, type, full, meta) {
            ...
            return `
              <div class="d-flex align-items-center text-nowrap">
                <img src="${assetsPath}img/icons/payments/${method}.png" alt="${method}" class="me-2" width="29">
                <span><i class="icon-base ri ri-more-line mt-1"></i>${methodNumber}</span>
              </div>`;
          }
        },
        {
