...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_customer_table) {
    var dt_customer = new DataTable(dt_customer_table, {
      ...
      layout: {
        topStart: {
          rowClass: 'row m-3 my-0 ms-0 me-2 justify-content-between',
          features: [
            {
              search: {
          ...
          features: [
            ...
            },
            {
              buttons: [
                ...
                {
                  text: '<span class="d-flex align-items-center gap-1"><i class="icon-base ri ri-add-line icon-xs"></i> <span class="d-none d-sm-inline-block">Add Customer</span></span>',
  ...
  setTimeout(() => {
    const elementsToModify = [
      ...
      { selector: '.dt-buttons .btn-group ~ .btn', classToRemove: 'btn-secondary' },
      { selector: '.dt-length', classToAdd: 'mt-0 mt-md-5' },
