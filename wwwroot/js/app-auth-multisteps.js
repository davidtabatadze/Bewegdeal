    ...
    (function () {
        ...
        if (typeof stepsValidation !== undefined && stepsValidation !== null) {
            ...
            function validateGeneralManualFields() {
                ...
                const toCheck = [
                    { el: generalStep.querySelector('[name="mobile"]'), msg: 'Bitte Telefonnummer eingeben' }
                ];
                if (isCompany) {
            ...
            const roleValidation = FormValidation.formValidation(roleStep, {
                fields: {
                    role: {  // matches input name="role"
                        validators: {
                            notEmpty: {
                                message: 'Bitte Kontotyp auswählen'
                            }
                        }
                    }
                },
                    ...
                    switch (validationStepper._currentIndex) {
                        ...
                        case 2:
                            ...
                            if (agreeTerms && !agreeTerms.checked) {
                                ...
                                fb.textContent = 'Sie müssen den AGB zustimmen';
                            ...
                            if (servicesSection && !servicesSection.classList.contains('d-none')) {
                                ...
                                if (!anyService) {
                                    ...
                                    svcFb.textContent = 'Bitte mindestens einen Dienst auswählen';
