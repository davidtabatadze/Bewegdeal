...
(function () {
  ...
  <div class="dz-details">
    ...
    const destAddressWrapper = document.getElementById('deliveryAddress')?.closest('.col-12')?.closest('.row')?.closest('.col-12');

    function toggleDestinationAddress(service) {
        if (!destAddressWrapper) { return; }
        const destZip = document.getElementById('deliveryZipCode');
