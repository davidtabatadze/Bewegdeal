...
document.addEventListener('DOMContentLoaded', function (e) {
              ...
              buttons: [
                {
                  ...
                  text: '<span class="d-flex align-items-center gap-2"><i class="icon-base ri ri-edit-box-line me-sm-1"></i> <span class="d-none d-sm-inline-block">Export</span></span>',
                  buttons: [
                    {
                      extend: 'print',
  ...
  setTimeout(() => {
    const elementsToModify = [
      ...
      { selector: '.dt-length', classToAdd: 'me-2' },
      { selector: '.dt-length .form-select', classToAdd: 'mx-sm-2 mx-0' },
