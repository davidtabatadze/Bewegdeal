    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function (data, type, full) {
          ...
          const img = imageUrl
            ? '<img src="' + imageUrl + '" alt="" class="rounded" style="width:40px;height:40px;object-fit:cover;flex-shrink:0;">'
      ...
      },
      {
        ...
        width: '60px',
        render: function (data, type, full) {
          const map = serviceMap[full['service']];
          return "<span data-bs-toggle='tooltip' data-bs-placement='top' title='" + map.label + "'>" + map.icon + '</span>';
        }
      },
      {
        // Create date
